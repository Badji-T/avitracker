      ...
      <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
        <div>
          ...
          <div>
            ...
            {/* Afficher le message de succès après l'inscription réussie*/}
            {successMessage && ( 
            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-5">
                ...
                <div>
                  <Label>
                    Email (facultatif)<span className="text-error-500">*</span>
                  </Label>
                  <Input
                    type="email"
                    id="email"
                ...
                {/* <!-- Button --> */}
                <div>
                  <button type="submit" className="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-brand-500 shadow-theme-xs hover:bg-orange-700">
                    Creer mon compte
                  </button>
                </div>
              </div>
